...
std_chart<-function(qcode, type="raw", transform= NULL, collapse=NULL, logscale="",
    ...
    if (!missing(transform)){
        if (transform=="annpct") { # a special transform not part of Quandl
            transform<-NULL # use this for the Quandl call
            annpct<-TRUE
        } 
    }
...
std_chart(qcode="FRED/GDPC96",
          logscale="log10",
          main="Real Gross Domestic Product (GDP) Value",
          ylab="Billions of Dollars",
          trend="log")

std_chart(qcode="FRED/GDPC96",
          transform="annpct",
          main="Real Gross Domestic Product (GDP) % Change",
          ylab="Annual % Change",
          hline="mean",
          trend="linear")

std_chart(qcode="FRED/CPIAUCSL",
          transform="annpct",
          main="Inflation: CPI - All Items",
          ylab="Annual % Change",
          hline="mean")

std_chart(qcode="FRED/CPILFESL",
          transform="annpct",
          main="Core Inflation: CPI x Food and Energy",
          ylab="Annual % Change",
          hline="mean")

std_chart(qcode="FRED/UNRATE",
          main="Unemployment Rate",
          ylab="%",
          hline="mean")

std_chart(qcode="FRED/ALTSALES",
          main="Auto & Light Truck Sales",
          ylab="Millions of Units",
          hline="mean",
          trend="linear")

std_chart(qcode="FRED/MEHOINUSA672N",
          main="Real Median Household Income",
          ylab="Dollars",
          hline="mean")

std_chart(qcode="FRED/DSPI",
          logscale="log2",
          main="Disposable Personal Income",
          ylab="Billions of Dollars",
          trend="log")

std_chart(qcode="FRED/HOUST",
          main="Housing Starts: New Privately Owned",
          ylab="Thousands of Units",
          hline="mean")

std_chart(qcode="FRED/T10YIE",
          main="10Yr Breakeven Inflation Rate",
          ylab="%",
          hline="mean")

std_chart(qcode="FRED/CP",
          logscale="log2",
          main="Corporate Profits After-Tax",
          ylab="Billions of Dollars",
          trend="log")

std_chart(qcode="FRED/STLFSI",
          main="St. Louis Fed Fin'l Stress Index",
          ylab="Index",
          hline=0)

std_chart(qcode="CHRIS/CME_CL1",
          main="Oil: WTI Crude",
          ylab="Price",
          collapse="monthly",
          hline=0)

std_chart(qcode="CHRIS/ICE_B1",
          main="Oil: Brent Crude",
          ylab="Price",
          collapse="monthly",
          hline=0)

std_chart(qcode="MULTPL/SHILLER_PE_RATIO_MONTH",
          main="Valuation: Shiller P/E",
          ylab="P/E",
          hline="mean")

std_chart(qcode="FRED/DGS10",
          main="Interest Rates: 10Yr Tsy Const Mat",
          ylab="Rate %",
          hline="mean")

std_chart(qcode="FRED/DGS2",
          main="Interest Rates: 2Yr Tsy Const Mat",
          ylab="Rate %",
          hline="mean")

std_chart(qcode="FRED/DTB3",
          main="Interest Rates: 3Mo Tsy Bill",
          ylab="Rate %",
          hline="mean")

std_chart(qcode="CBOE/VIX",
          main="Volatility: VIX",
          ylab="VIX Index",
          hline="mean")

std_chart(qcode="FRED/DTWEXM",
          main="US Dollar v Major Currencies",
          ylab="Trade-Wtd Index",
          hline="mean")

std_chart(qcode="FRED/DTWEXB",
          main="US Dollar v Broad",
          ylab="Trade-Wtd Index",
          hline="mean")

std_chart(qcode="YAHOO/INDEX_GSPC",
          main="S&P 500 Index",
          ylab="Index",
          logscale = "log2",
          trend="log")
